...
while True:
	...
	resp = requests.get("https://wa.dad.id/search_projectlike?idproject=317&nourut=0&engine=com")
	...
	if(resp.status_code==200):
		...
		if(int(row["tot"])>0):
			...
			print('-------------------------------------------------------------')
			feed = requests.get("https://wa.dad.id/search_feed?nourut=0&idkeyword="+str(idkeyword)+"&engine=com&sosmed=instagram")
