		...
		while i < int(totfeed):
			for item in user_feed:
				...
				if 'user' in item.keys():
					...
					print("========================================================================================================================================")
					print("1. GET Posting INSTAGRAM project_id: "+str(idproject)+" ID:"+str(item['id'])+" Username:"+str(username)+" DatePost:"+str(utcdate)+" loop:"+str(i))
...
while True:
	pass
	resp = requests.get("https://wa.dad.id/search_project?nourut=3&engine=feed")
	...
	if(resp.status_code==200):
		...
		if(int(row["tot"])>0):
			...
			#api = InstagramAPI("nouval255", "nouval123")--> gak bsa login
