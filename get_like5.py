...
while True:
	pass
	resp = requests.get("https://wa.dad.id/search_projectlike?idproject=317&nourut=5&engine=like")
	...
	if(resp.status_code==200):
		...
		if(int(row["tot"])>0):
			...
			print('-------------------------------------------------------------')
			feed = requests.get("https://wa.dad.id/search_feed?nourut=5&idkeyword="+str(idkeyword)+"&engine=like&sosmed=instagram")
